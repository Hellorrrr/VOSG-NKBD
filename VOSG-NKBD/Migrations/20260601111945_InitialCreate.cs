        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Places_Locations_LocationsID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Confirmations_AspNetUsers_MemberId",
                        column: x => x.MemberId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Confirmations_Places_PlaceID",
                        column: x => x.PlaceID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PaymentID = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ConfirmationID = table.Column<int>(type: "INTEGER", nullable: false),
                    VOSG_NKBDId = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_AspNetUsers_VOSG_NKBDId",
                        column: x => x.VOSG_NKBDId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Payments_Confirmations_ConfirmationID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_VOSG_NKBDId",
                table: "Payments",
                column: "VOSG_NKBDId");

            migrationBuilder.CreateIndex(
                name: "IX_Places_LocationsID",
                table: "Places",
                column: "LocationsID");
        }
