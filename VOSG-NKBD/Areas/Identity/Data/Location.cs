...
{
    public class LocationsController(VOSG_NKBDDbContext context) : Controller
    {
        private readonly VOSG_NKBDDbContext _context = context;
        ...
        public JsonResult GetMatchingLocations(string term)
        {
            var matches = _context.Locations
                .Where(l => l.LocationName.Contains(term)).Select(l => l.LocationName).Take(10).ToList();
